    ...
    >
      <div className=" py-2 flex-1 flex flex-col items-start justify-center gap-4">
        ...
        <p className=" text-[2.5rem] lg:text-[3.5rem] font-bold tracking-wide text-headingColor leading-tight">
          ...
          <span className=" text-orange-600 text-[2.5rem] lg:text-[3.5rem]">
            {" "}
            love of food!
          </span>
        </p>
        ...
        <button
          type="button"
          className="bg-orange-600 text-white w-full md:w-auto px-4 py-3 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 border-none  "
        >
          Order Now
        </button>
      </div>
        ...
        <div className="w-full h-full absolute top-0 left-0  flex items-center justify-center lg:px-32 py-4 gap-4 flex-wrap ">
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
                className=" lg:w-190  p-6 bg-cardOverlay backdrop-blur rounded-3xl flex flex-col items-center justify-center"
              >
                <img
                  src={n.imageSrc}
